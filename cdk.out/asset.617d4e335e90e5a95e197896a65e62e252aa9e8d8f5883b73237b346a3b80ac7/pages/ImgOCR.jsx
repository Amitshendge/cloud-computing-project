...
const ImgOCR = () => {
  ...
  const handleDownloadButtonClick = async () => {
    ...
    Axios.post('https://x1px07x8w5.execute-api.us-east-1.amazonaws.com/development/img_crop', CropedImages
    )
    .then(response => {
  ...
  const handleDownloadSampleButtonClick = async () => {
    ...
    Axios.get('https://x1px07x8w5.execute-api.us-east-1.amazonaws.com/development/presigned_download', {params:{key: 'test_images/all_images.jpg'}}
    )
    .then(response => {
      window.open(response.data.body.download_url);
      setLoading(false);
  ...
  const handleStartProcessButtonClick = async () => {
    ...
    Axios.get('https://2vfh6ju6iq22k54ksjhzk43a5u0dasyp.lambda-url.us-east-1.on.aws/', {
      params,
    })
    .then(response => {
  ...
  const handleUploadButtonClick_dummy = async () => {
    try{
      ...
      const response = await Axios.get('https://x1px07x8w5.execute-api.us-east-1.amazonaws.com/development/presigned_upload', {
        params: {
          key: `uploaded_raw_images/${currentTime_id}/`+image.name,
        },
      })
  ...
  return (
    <div className="image-upload-container">
      <Menu></Menu>
      <h1>Still Building not completed Yet, Sorry for inconvinience</h1>
