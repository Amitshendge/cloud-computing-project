...
var file;
const api_base_url = my_file.REACT_APP_api_base_url
const func_url_yolo = my_file.REACT_APP_func_url_yolo
const ImgCutter = () => {
  ...
  const handleDownloadButtonClick = async () => {
    ...
    Axios.post(`${api_base_url}/img_crop`, CropedImages
    )
    .then(response => {
  ...
  const handleDownloadSampleButtonClick = async () => {
    ...
    Axios.get(`${api_base_url}/presigned_download`, {params:{key: 'test_images/all_images.jpg'}}
    )
    .then(response => {
      window.open(response.data.body.download_url);
      setLoading(false);
  ...
  const handleUploadButtonClick_dummy = async () => {
    try{
      ...
      const response = await Axios.get(`${api_base_url}/presigned_upload`, {
        params: {
          key: `uploaded_raw_images/${currentTime_id}/`+image.name,
        },
      })
